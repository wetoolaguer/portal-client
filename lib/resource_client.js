...
//Constructor
var ResourceClient = function (baseuri, uris, requestClient) {
...
ResourceClient.prototype.get = function (item, callback) {
    ...
    var uri = this.baseURI + getResourceURI(GET, this.URIs);
...
ResourceClient.prototype.post = function (formObj, callback) {
    var self = this;
    var uri = this.baseURI + getResourceURI(POST, this.URIs);
...
ResourceClient.prototype.put = function (item, formObj, callback) {
    var self = this;
    var uri = this.baseURI + getResourceURI(PUT, this.URIs) + "/" + item;
    var multipart = isMultipart(formObj);
...
ResourceClient.prototype.del = function (item, callback) {
    ...
    var uri = this.baseURI + getResourceURI(DEL, this.URIs);
...
ResourceClient.prototype.findBy = function (params, callback) {
    ...
    var uri = this.baseURI + getResourceURI(GET, this.URIs) + paramString;
