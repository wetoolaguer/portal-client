var NamespaceFactory = require('../lib/namespace_factory');
var ResourceClient = require('../lib/resource_client');
var defaultRoutes = require('./routes');
var request = require ('request');


var RestClient = function (conf, newRoutes) {
    var config = conf;
    var routes = newRoutes || defaultRoutes;
